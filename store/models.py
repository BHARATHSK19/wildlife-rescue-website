...
class Address(models.Model):
    ...
    locality = models.CharField(max_length=150, verbose_name="Name and age")
    city = models.CharField(max_length=150, verbose_name="City and states")
    state = models.CharField(max_length=150, verbose_name="phone number and gmail")
